...
namespace ProvaPub.Controllers
{
	...
	{
		[HttpGet("orders")]
		public async Task<Order> PlaceOrder(int paymentMethod, decimal paymentValue, int customerId)
		{
			return await new OrderService().PayOrder((PaymentOption)paymentMethod, paymentValue, customerId);
		}
	}
}
